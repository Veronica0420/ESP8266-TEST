...
public class EepromLayout extends Fragment implements ActivityToFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_eeprom_layout,container,false);
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mFragmentListener != null) {
                    mFragmentListener.getETContent("Eeprom",etSend.getText().toString());
                }

                Log.d("react","Eeprom.click");
    ...
    public void setTemp(String temp) {
        if(temp=="2"){
            tvContent.setText("读写错误");

        }
        else
        {
            tvContent.setText(etSend.getText().toString());
        }
